      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 shadow-2xl shadow-black/40">
          ...
          <div className="space-y-3">
            <button
              onClick={googleLogin}
              className="w-full bg-gray-800/80 hover:bg-gray-700 text-white font-bold py-3 rounded-xl transition-all active:scale-[0.98] flex items-center justify-center gap-3 border border-gray-700/50 shadow-lg group"
            >
              ...
              <span className="flex-1 text-center">تسجيل الدخول عبر Google</span>
            </button>
            <button
            ...
            >
              ...
              <span className="flex-1 text-center">تسجيل الدخول عبر Discord</span>
            </button>
          </div>
        </div>
      </div>
